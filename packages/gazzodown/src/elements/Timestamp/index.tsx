...
const ShortTime = ({ value }: { value: number }) => (
	<Time value={lightFormat.lightFormat(new Date(value), 'HH:mm')} dateTime={new Date(value).toISOString()} />
);

// eslint-disable-next-line react/no-multi-comp
const LongTime = ({ value }: { value: number }) => (
	<Time value={lightFormat.lightFormat(new Date(value), 'HH:mm:ss')} dateTime={new Date(value).toISOString()} />
);

// eslint-disable-next-line react/no-multi-comp
const ShortDate = ({ value }: { value: number }) => (
	<Time value={lightFormat.lightFormat(new Date(value), 'dd/MM/yyyy')} dateTime={new Date(value).toISOString()} />
);
// eslint-disable-next-line react/no-multi-comp
const LongDate = ({ value }: { value: number }) => (
	<Time value={lightFormat.lightFormat(new Date(value), 'dd/MM/yyyy HH:mm:ss')} dateTime={new Date(value).toISOString()} />
);

// eslint-disable-next-line react/no-multi-comp
const FullDate = ({ value }: { value: number }) => (
	<Time value={format.format(new Date(value), 'EEEE MMMM d, yyyy h:mm a')} dateTime={new Date(value).toISOString()} />
);

// eslint-disable-next-line react/no-multi-comp
const FullDateLong = ({ value }: { value: number }) => (
	<Time value={format.format(new Date(value), 'EEEE MMMM d, yyyy h:mm:ss a')} dateTime={new Date(value).toISOString()} />
);
