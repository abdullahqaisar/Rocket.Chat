...
const ForwardChatModal = ({
	...
	console.log('🚀 ~ allowForwardToOfflineAgent:', allowForwardToOfflineAgent);

	console.log('🚀 ~ idleAgentsAllowedForForwarding:', idleAgentsAllowedForForwarding);
				...
				<FieldGroup>
					...
					<Field>
						...
						<FieldRow>
							<AutoCompleteAgent
								withTitle
								onlyAvailable={!idleAgentsAllowedForForwarding}
